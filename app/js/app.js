...
const app = () => {
  return {
    ...
    toggleSearch(event = null) {
      if ((event != null && !this.isSearchActive) || !this.searchValue.length) {
...
if (promo) {
  ...
  new Swiper(promo, {
    slidesPerView: "auto", slidesOffsetBefore: distanceToLeft.left, autoplay: {
      delay: 3000,
    }, breakpoints: {
      320: {
        spaceBetween: 15,
...
if (certs) {
  new Swiper(certs, {
    spaceBetween: 20, observer: true, observeParents: true, navigation: {
      prevEl: ".certs .slider__arrows_item--prev", nextEl: ".certs .slider__arrows_item--next",
    }, breakpoints: {
      320: {
...
if (catalog.length > 0) {
  catalog.forEach((item) => {
    new Swiper(item, {
      spaceBetween: 20, observer: true, observeParents: true, navigation: {
        prevEl: ".products .slider__arrows_item--prev", nextEl: ".products .slider__arrows_item--next",
      }, breakpoints: {
        320: {
          slidesPerView: 1, spaceBetween: 15,
        }, 600: {
...
if (productThumbs && productGallery) {
  const thumbsSlider = new Swiper(productThumbs, {
    slidesPerView: 5, mousewheel: true, spaceBetween: 20, loop: true, slidesPerSlide: 1, breakpoints: {
      320: {
  ...
  const gallerySlider = new Swiper(productGallery, {
    slidesPerView: 1, loop: true, spaceBetween: 20, thumbs: {
      swiper: thumbsSlider,
    },
  });
}
